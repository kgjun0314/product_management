...
public class SimpleProductServiceUnitTest {
    ...
    void productAddTest() {
        ...
        assertTrue(savedProductDto.getName().equals(product.getName()));
        assertTrue(savedProductDto.getPrice().equals(product.getPrice()));
        assertTrue(savedProductDto.getAmount().equals(product.getAmount()));
    }
}
